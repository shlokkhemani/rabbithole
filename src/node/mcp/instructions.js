export const SERVER_INSTRUCTIONS = [
  ...
  "",
  "A branch_request carries the selection, the question, the lineage of titles, and a map of the whole canvas. It may include thread: lineage markdown the server thinks you never received. Empty selected_text means a question about the parent document as a whole. notes are the human's margin notes: on_lineage ones are the text being replied to; others are context, not questions. If the ask refers to a node, note, or ruling whose text you do not hold verbatim in context, call read_rabbithole with thread_of before answering.",
  "",
  "The card shows nothing until a call lands. answer_branch with partial:true renders at once and returns immediately; chunks concatenate verbatim.",
  "",
