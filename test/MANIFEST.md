...
| shared setup key-field eye toggle | C2 | Guards the single model-settings credential field by requiring password/text and `aria-pressed` to change together during first-run setup. | Chrome: credential entry and accessible state |
